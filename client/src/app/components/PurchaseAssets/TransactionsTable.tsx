...
function TransactionsTable() {
    const [transactions, setTransactions] = useState<Transaction[]>([
        {
            txnHash: "e961169d851dd89d15467bcbef7193a6c6a3730ca469389459de39a26524471",
            investorAddress: "0xabcdef1234567890abcdef1234567890abcdef12",
            tokenAmount: 1,
            diamAmount: 50,
            url: "https://testnetexplorer.diamcircle.io/about-txHash/e961169d851dd89d15467bcbef7193a6c6a3730ca469389459de39a26524471e",
        },
        {
            txnHash: "e961169d851dd89d15467bcbef7193a6c6a3730ca469389459de39a265244e",
        ...
        {
            txnHash: "e961169d851dd89d15467bcbef7193a6c6a3730ca469389459de39a2652e",
            investorAddress: "0xabcdef1234567890abcdef1234567890abcdef12",
            tokenAmount: 3,
            diamAmount: 150,
            url: "https://testnetexplorer.diamcircle.io/about-txHash/e961169d851dd89d15467bcbef7193a6c6a3730ca469389459de39a26524471e",
        ...
        {
            txnHash: "e961169d851dd89d15467bcbef7193a6c6a3730ca469389459de39a261e",
            investorAddress: "0x1234567890abcdef1234567890abcdef12345678",
            tokenAmount: 4,
            diamAmount: 200,
            url: "https://testnetexplorer.diamcircle.io/about-txHash/e961169d851dd89d15467bcbef7193a6c6a3730ca469389459de39a26524471e",
            ...
            <div className="flex flex-col w-full max-w-7xl bg-white dark:bg-gray-800 shadow-lg rounded-lg mt-8 p-6">
                <div className="flex flex-row justify-between items-center">
                    <div className="flex flex-col justify-between items-left mb-1">
                        <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-200">Investments</h1>
                        <p className="text-lg text-gray-800 dark:text-gray-200 mb-3">Showing the most recent Investments</p>
                    </div>
                    <button
                        type="button"
                ...
                {loading ? (
                    ...
                    <>
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr>
                                    <th className="border-b p-4 text-gray-800 dark:text-gray-200">Transaction Hash</th>
                                    <th className="border-b p-4 text-gray-800 dark:text-gray-200">Investor Address</th>
                                    <th className="border-b p-4 text-gray-800 dark:text-gray-200">Token Amount</th>
                                    <th className="border-b p-4 text-gray-800 dark:text-gray-200">DIAM Amount</th>
                                    <th className="border-b p-4 text-gray-800 dark:text-gray-200">Transaction URL</th>
                                </tr>
                            </thead>
                            <tbody>
                                {transactions.length === 0 ? (
                                    <tr>
                                        <td colSpan={5} className="border-b p-4 text-gray-800 dark:text-gray-200 text-center">No transactions found.</td>
                                    </tr>
                                ) : (
                                    currentSchemas.map((txn) => (
                                        <tr key={txn.txnHash}>
                                            ...
                                            <td className="border-b p-4 text-gray-800 dark:text-gray-200 ">{truncateTxHash(txn.investorAddress)}  
                                            </td>
                                            <td className="border-b p-4 text-gray-800 dark:text-gray-200">{txn.tokenAmount}</td>
                                            <td className="border-b p-4 text-gray-800 dark:text-gray-200">{txn.diamAmount}</td>
                                            <td className="border-b p-4 text-gray-800 dark:text-gray-200">
                                                <Link href={txn.url} legacyBehavior>
                                                    <a className="text-blue-600 hover:underline">View Transaction</a>
                                                </Link>
                                            </td>
                                        </tr>
                                    ))
