...
function TransactionsTable() {
   ...
   const fetchTransactions = async () => {
       try {
           setLoading(true);
           const response = await fetch("http://localhost:8000/getTransactionsData", {
               method: "GET",
                               ...
                               {transactions.length === 0 ? (
                                   ...
                                   currentSchemas.map((txn) => (
                                       <tr key={txn.txnHash}>
                                           ...
                                           <td className="border-b p-4 text-gray-800 dark:text-gray-200">{truncateTxHash(txn.investorAddress)}</td>
